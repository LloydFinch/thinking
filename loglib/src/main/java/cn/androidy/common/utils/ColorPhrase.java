...
public class ColorPhrase {
     ...
     * @return
     */
    public ColorPhrase outerColorSize(int _outerColor, float _outerSize) {
     ...
     * @return
     */
    public ColorPhrase innerColorSize(int _innerColor, float _innerSize) {
    ...
    private static class OuterToken extends Token {
        ...
        void expand(SpannableStringBuilder target) {
            ...
            if (outerSize > 0) {
                target.setSpan(new AbsoluteSizeSpan((int) outerSize), startPoint, endPoint, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
        }
    ...
    private static class InnerToken extends Token {
        ...
        void expand(SpannableStringBuilder target) {
            ...
            if (innerSize > 0) {
                target.setSpan(new AbsoluteSizeSpan((int) innerSize), replaceFrom, replaceTo - 2, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
        }
