...
public class GridListView2x1 extends MultiColumnLayout {
    public GridListView2x1(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public GridListView2x1(Context context, float heightWidthRatio, int widthInPx) {
    ...
    public class ItemLayout extends RelativeLayout implements IMultiColumnItem {
        ...
        public ItemLayout(Context context) {
            ...
            LayoutParams p = new LayoutParams(LayoutParams.MATCH_PARENT, (int) (dm.density * 100));
